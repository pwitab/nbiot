...
class SaraN211Module:
    ...
    def connect(self, operator: int, roaming=False):
        ...
        if self.registered:
            logger.info(f'Already registered to {operator} with registration '
    ...
    def ping(self, ip):
        ...
        result = self._read_line_until_contains('+NPING', timeout=20,
                                                capture_urc=True)
        ...
        if ping_err:
            ...
            err_map = {1: 'No response from remote host',
