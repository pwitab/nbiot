...
class AppContext:
    ...
    def __init__(self, module, mno, psm=False):
        self.module = module
        self.mno = mno
        self.psm = psm
...
def cli(ctx, port, roaming, mno, loglevel, psm):
    ...
    try:
        ...
        serial_error_nr_map = {
            16: (f'Resource busy. Are you sure no '
                 f'other process is using port {port}')
        }
    ...
    ctx.obj = AppContext(module=nbiot_module, mno=mno, psm=psm)
